...
public class LedgeGrabbing : MonoBehaviour
{
    ...
    [SerializeField, Tooltip("PlayerCam.")]
    public Transform cam;
    public Rigidbody rb;

    [Header("Ledge Grabbing")]
    public float moveToLedgeSpeed = 12f;
    public float maxLedgeGrabDistance = 2f;

    public float minTimeOnLedge = .5f;
    ...
    public float ledgeJumpForwardForce = 14f;
    public float ledgeJumpUpwardForce = 5f;

    [Header("Ledge Detection")]
    public float ledgeDetectionLength = 3f;
    public float ledgeSphereCastRadius = .5f;
